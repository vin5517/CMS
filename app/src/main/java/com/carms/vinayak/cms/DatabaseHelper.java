...
//        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + T1_TABLE_NAME + "( " + T1_COL_1 + " INTEGER PRIMARY KEY AUTOINCREMENT, " + T1_COL_2 + " TEXT, " + T1_COL_3 + " TEXT, " + T1_COL_4 + " TEXT, " + T1_COL_5 + " TEXT) ");
        db.execSQL("CREATE TABLE " + T2_TABLE_NAME + "( " + T2_COL_1 + " INTEGER PRIMARY KEY AUTOINCREMENT, " + T2_COL_2 + " TEXT, " + T2_COL_3 + " TEXT, " + T2_COL_4 + " TEXT, " + T2_COL_5 + " TEXT, " + T2_COL_6 + " TEXT, " + T2_COL_7 + " TEXT, " + T2_COL_8 + " TEXT, " + T2_COL_9 + " TEXT, " + T2_COL_10 + " INTEGER NOT NULL, FOREIGN KEY (" + T2_COL_10 + ") REFERENCES " + T1_TABLE_NAME + "(" + T1_COL_1 + ")) ");
        db.execSQL("CREATE TABLE " + T3_TABLE_NAME + "( " + T3_COL_1 + " INTEGER PRIMARY KEY AUTOINCREMENT, " + T3_COL_2 + " TEXT, " + T3_COL_3 + " TEXT, " + T3_COL_4 + " TEXT, " + T3_COL_5 + " TEXT, " + T3_COL_6 + " TEXT, " + T3_COL_7 + " TEXT, " + T3_COL_8 + " INTEGER NOT NULL, FOREIGN KEY (" + T3_COL_8 + ") REFERENCES " + T2_TABLE_NAME + "(" + T2_COL_1 + ")) ");
        db.execSQL("CREATE TABLE " + T4_TABLE_NAME + "( " + T4_COL_1 + " INTEGER PRIMARY KEY AUTOINCREMENT, " + T4_COL_2 + " TEXT, " + T4_COL_3 + " TEXT, " + T4_COL_4 + " TEXT, " + T4_COL_5 + " TEXT, " + T4_COL_6 + " TEXT, " + T4_COL_7 + " TEXT, " + T4_COL_8 + " INTEGER NOT NULL, FOREIGN KEY (" + T4_COL_8 + ") REFERENCES " + T2_TABLE_NAME + "(" + T2_COL_1 + ")) ");
